export const skillsData = {
  languages: [
    ...
    { name: 'Python', icon: '/icons/python.webp', description: 'Python for scripting and backend development' },
    { name: 'HTML', icon: '/icons/html.webp', description: 'Semantic HTML5 markup for modern web applications' },
    { name: 'CSS', icon: '/icons/css.webp', description: 'Advanced CSS3 including Flexbox, Grid, and animations' },
    { name: 'SQL', icon: '/icons/sql.webp', description: 'SQL for database queries and manipulation' }
  ],
  frameworks: [
    ...
    { name: 'React Query', icon: '/icons/react-query.webp', description: 'Data fetching and state management library for React applications' }
  ],
  databases: [
